...
[InitializeOnLoad]
class AvatarCleaner : EditorWindow
{
    ...
    //[UnityEditor.MenuItem("Ahzkwid/AvatarTools/CreatorTools/" + nameof(AvatarCleaner))]
    public static void Init()
    {
        var window = GetWindow<AvatarCleaner>(utility: false, title: nameof(AvatarCleaner));
